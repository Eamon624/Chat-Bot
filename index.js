            ...
            for( var i in body.results){
                if(body.results[i].route == busNumber || all == true){
                    ...
                    if(body.results[i].duetime === "Due"){
                        message += "▪️" +body.results[i].route + " to " + body.results[i].destination + " is due now.▪️\n\n"   ;
                    }
                    //Stop 1 minute appearing as "1 minutes"
                    else if(body.results[i].duetime === "1"){
                        message += "▪️" +body.results[i].route + " to " + body.results[i].destination + "bis due in " + body.results[i].duetime
                        + " minute.▪️\n\n"   ;
                    }
                    else{
                        message += "▪️" +body.results[i].route + " to " + body.results[i].destination + " is due in " + body.results[i].duetime
                        + " minutes.▪️\n\n"   ;
                    }
                    resultCount++;
                }
